...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sdnfirewall";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:sdnfirewall";
    private final String revision = "2015-01-05";
    private final String resourcePath = "/META-INF/yang/sdnfirewall.yang";
